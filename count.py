...
#         name.append(first+str(i))
#         name[i-1]=QTableWidgetItem()
#         print(str(name[i-1]))
#         self.tableWidget.setHorizontalHeaderItem(0, name[i-1])
# for i in range(0, len(count.cp)-1):
        #     if(i == 0):
        #         count.name.append(count.first)
        #         count.name[i]=QTableWidgetItem()
        #         self.tableWidget.setHorizontalHeaderItem(i,count.name[i])
        #     else:
        #         count.name.append(count.first+str(i))
        #         count.name[i]=QTableWidgetItem()
        #         self.tableWidget.setHorizontalHeaderItem(i,count.name[i])
